package com.zsck.bot.http.academic.util;
 ...
 */
@Component
public class ClassTableResolver {
    ...
    public void setMessageContentBuilderFactory(MessageContentBuilderFactory messageContentBuilderFactory) {
        ClassTableResolver.messageContentBuilderFactory = messageContentBuilderFactory;
    }

    @Autowired
    public void setClassNameService(ClassNameService classNameService) {
        ClassTableResolver.classNameService = classNameService;
    }
}
